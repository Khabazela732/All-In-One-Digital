...
from .forms import LogbookTemplateForm, ReportForm, RotationForm
...
from administration.models import Deliverable,WorkItem, InternDeliverable, InternLogbook, IntershipEnrollment, Intern, Application, LogbookTemplate, LogbookTemplateDeliverable, Shift, User
...
class RotationListView(LoginRequiredMixin, ListView):
    model = Rotation
    template_name = "pages/rotation/rotation_list.html"
    context_object_name = "rotations"

    def get_queryset(self):
        return Rotation.objects.select_related('intern', 'department', 'work_item').prefetch_related('deliverables')

class RotationCreateView(LoginRequiredMixin, CreateView):
    model = Rotation
    form_class = RotationForm
    template_name = "pages/rotation/rotation_create.html"
